...
<template>
  ...
  <div class="min-h-screen bg-background text-white font-sans flex flex-col">
    ...
    >
      ...
      <router-link
        to="/"
        class="text-lg sm:text-xl font-bold text-accent"
      ></router-link>
    ...
    <div
      v-if="navOpen"
      class="md:hidden fixed top-16 left-0 w-full bg-gray-900/95 backdrop-blur shadow-lg z-40 transition-all duration-300"
    >
